    ...
    foreach($worker as $user):?>
        <tr class="<?if($k==0):?>table-info-user<?endif;?> <?if($k+1==count($worker)):?>last-border<?endif;?>">
            ...
            <td class="action-btn"><!--<span class="right-sp"></span>-->
                <a class="view" href="{{URL::route('worker.show',array('id'=>$user->id))}}"><img src="/images/see.png" alt=""/></a>
                <a class="edit" href="{{URL::route('worker.edit',array('id'=>$user->id))}}"><img src="/images/edit.png" alt=""/></a>
